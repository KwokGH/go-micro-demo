...
func (c *productService) AddProduct(ctx context.Context, in *AddProductRequest, opts ...client.CallOption) (*AddProductResponse, error) {
...
func (h *productHandler) AddProduct(ctx context.Context, in *AddProductRequest, out *AddProductResponse) error {
