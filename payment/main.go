...
import (
	...
	"github.com/Kwok/microdemo/payment/domain/repository"
	"github.com/Kwok/microdemo/payment/domain/service"
	"github.com/Kwok/microdemo/payment/handler"
...
func initApp(srv micro.Service) {
	...
	productService := service.NewPaymentDataService(repo)
	productHandler := handler.New(productService)

	// Register handler
	pb.RegisterPaymentHandler(srv.Server(), productHandler)
}
